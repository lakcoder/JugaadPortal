...
<div class="container" >
    ...
    <form class="form-horizontal" method ="post" action="submit.php">
        ...
        <div class="well col-lg-4">
            <h2 style="text-align: center">MEMBER 1</h2>
            <br>
            ...
            <br>
            <div class="form-group">
                <input class="form-control" type="text" name="contact[]" pattern="[789][0-9]{9}" placeholder="CONTACT" autocomplete="off" required>
            </div>
            <br>
            <div class="form-group">
        ...
        <div class=" well col-lg-4">
            <h2 style="text-align: center">MEMBER 2</h2>
            <br>
            <div class="form-group">
                <input class="form-control" type="text" name="name[]" placeholder="NAME" required>
        ...
        <div class=" well col-lg-4">
            <h2 style="text-align: center">MEMBER 3</h2>
            <br>
            <div class="form-group">
                <input class="form-control" type="text" name="name[]" placeholder="NAME" required>
        ...
        <div class=" well col-lg-4">
            <h2 style="text-align: center">MEMBER 4</h2>
            <br>
            <div class="form-group">
                <input class="form-control" type="text" name="name[]" placeholder="NAME" required>
        ...
        <div class="col-lg-4"></div>
        <div class=" well col-lg-4">
            <h2 style="text-align: center">MEMBER 5</h2>
            <br>
            <div class="form-group">
                <input class="form-control" type="text" name="name[]" placeholder="NAME" required>
